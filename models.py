...
class Order(db.Model):
    ...
    data1 = db.Column(db.DateTime)
    orderdetails_id_l = db.Column(db.Integer, db.ForeignKey('orderdetails.orderdetails_id'), nullable=False)
    orderdetails_id_f = db.Column(db.Integer, db.ForeignKey('orderdetails.orderdetails_id'), nullable=False)
